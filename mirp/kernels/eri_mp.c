...
void mirp_prim_eri_mp(mpfr_t * result,
                      ...
                      mpfr_prec_t working_prec)
{
    mirp_prim_cartloop4_mp(result,
                           am1, A, alpha1,
                           am2, B, alpha2,
                           am3, C, alpha3,
                           am4, D, alpha4,
                           working_prec, mirp_single_eri_mp);
}

void mirp_eri_mp(mpfr_t * result,
