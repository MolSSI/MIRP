...
void mirp_integral4_target_str(arb_ptr integrals,
                               int am1, const char ** A, int nprim1, int ngeneral1, const char ** alpha1, const char ** coeff1,
                               int am2, const char ** B, int nprim2, int ngeneral2, const char ** alpha2, const char ** coeff2,
                               int am3, const char ** C, int nprim3, int ngeneral3, const char ** alpha3, const char ** coeff3,
                               int am4, const char ** D, int nprim4, int ngeneral4, const char ** alpha4, const char ** coeff4,
                               slong target_prec, cb_integral4 cb);
