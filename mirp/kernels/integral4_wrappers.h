...
/*! \brief Computes all cartesian components of an integral over contracted shells
 *         to a target precision (four center)
 *
 * This function seeks to calculate the integrals to a given precision. This works
 * by increasing the working precision until the result is the desired
 * precision (\p target_prec).
 *
 * If the inputs are not of high enough precision to reach the target
...
/*! \brief Wraps a function that computes a single integral in a function
 *         that computes all 
 */
