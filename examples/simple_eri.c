...
int main(void)
{
    ...
    mirp_eri_d(integrals_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d);

    mirp_eri(integrals_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval, 512);
    ...
    mirp_eri_d(integrals_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s2_d, coeff_O_s2_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s1_d, coeff_O_s1_d,
               8, 0, xyz_O_d, 3, 1, alpha_O_s2_d, coeff_O_s2_d);

    mirp_eri(integrals_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s2_interval, coeff_O_s2_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s1_interval, coeff_O_s1_interval,
             8, 0, xyz_O_interval, 3, 1, alpha_O_s2_interval, coeff_O_s2_interval, 512);
    ...
    /* {3, 2, 4, 1} */
    mirp_eri_d(integrals_d,
               1, 0, xyz_H1_d, 3, 1, alpha_H1_s_d, coeff_H1_s_d,
               8, 1, xyz_O_d,  3, 1, alpha_O_p_d,  coeff_O_p_d,
               1, 0, xyz_H2_d, 3, 1, alpha_H2_s_d, coeff_H2_s_d,
               8, 0, xyz_O_d,  3, 1, alpha_O_s2_d, coeff_O_s2_d);

    mirp_eri(integrals_interval,
             1, 0, xyz_H1_interval, 3, 1, alpha_H1_s_interval, coeff_H1_s_interval,
             8, 1, xyz_O_interval,  3, 1, alpha_O_p_interval,  coeff_O_p_interval,
             1, 0, xyz_H2_interval, 3, 1, alpha_H2_s_interval, coeff_H2_s_interval,
             8, 0, xyz_O_interval,  3, 1, alpha_O_s2_interval, coeff_O_s2_interval, 512);
    ...
    mirp_eri(integrals_interval,
             ...
             8, 1, xyz_O_interval, 3, 1, alpha_O_p_interval, coeff_O_p_interval,
             8, 1, xyz_O_interval, 3, 1, alpha_O_p_interval, coeff_O_p_interval,
             8, 1, xyz_O_interval, 3, 1, alpha_O_p_interval, coeff_O_p_interval, 512);
